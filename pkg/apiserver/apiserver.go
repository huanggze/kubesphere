...
import (
	...
	monitoringv1alpha2 "kubesphere.io/kubesphere/pkg/kapis/monitoring/v1alpha3"
...
func (s *APIServer) installKubeSphereAPIs() {
	...
	urlruntime.Must(monitoringv1alpha2.AddToContainer(s.container, s.KubernetesClient.Kubernetes(), s.MonitoringClient))
